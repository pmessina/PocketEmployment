...
class InterviewsThisMonthFragment : Fragment(), KoinComponent, LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    {
        Toast.makeText(requireContext(), "Interviews This Month: ${cursor.count}", Toast.LENGTH_SHORT).show()
    ...
    {
        Toast.makeText(requireContext(), "Refreshing Interviews This Month", Toast.LENGTH_SHORT).show()
