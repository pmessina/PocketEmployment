...
class RecruitersFragment : Fragment() //implements ServiceConnection

{
    ...
    //
    //        //TODO: change to desired Activity
    //        intent = new Intent(context, RecruiterCallsActivity.class);
    //        PendingIntent pendingIntent = PendingIntent.getActivity(getActivity(), 0, intent, 0);
    //        Notification notification = CallsNotificationManager.getInstance(recruiterCallService).setUpNotification(1, "Service Started", pendingIntent, true);
    //
    //        recruiterCallService.startForeground(NOTIF_ID, notification);
    //
    //    }
    //
    //    @Override
    ...
    //    {
    //        CallsNotificationManager.getInstance(recruiterCallService).stopNotification(1);
    //    }
